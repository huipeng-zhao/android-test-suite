...
class LifeKeeper(context: Context) : ServiceConnection, BroadcastReceiver() {
    companion object {
        private const val TAG = "wallwall LifeKeeper"
        private const val PERIPHERAL_PACKAGE = "com.android.ware.peripheral"
        private const val PERIPHERAL_SERVICE_CLASS: String = "com.android.ware.peripheral.PeripheralService"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        if (intent.action != null) {
            val userId: Int = UserController.getCarriedUserIdWithIntent(intent)
    ...
    private fun connect() {
        ...
        Log.d(TAG, "connect(), mPeripheralServiceComponent: $mPeripheralServiceComponent")
